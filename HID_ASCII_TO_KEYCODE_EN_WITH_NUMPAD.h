...
#define HID_ASCII_TO_KEYCODE_EN_WITH_NUMPAD \
  { 0, 0 },                   /* 0x00 Null      */ \
    { 0, 0 },                 /* 0x01           */ \
    { 0, 0 },                 /* 0x02           */ \
    { 0, 0 },                 /* 0x03           */ \
...
\
    ...
    { LEFTSHIFT, HID_KEY_1 },          /* 0x21 !         */ \
    { LEFTSHIFT, HID_KEY_APOSTROPHE }, /* 0x22 "         */ \
    { LEFTSHIFT, HID_KEY_3 },          /* 0x23 #         */ \
    { LEFTSHIFT, HID_KEY_4 },          /* 0x24 $         */ \
    { LEFTSHIFT, HID_KEY_5 },          /* 0x25 %         */ \
    { LEFTSHIFT, HID_KEY_7 },          /* 0x26 &         */ \
    { 0, HID_KEY_APOSTROPHE },         /* 0x27 '         */ \
    { LEFTSHIFT, HID_KEY_9 },          /* 0x28 (         */ \
    { LEFTSHIFT, HID_KEY_0 },          /* 0x29 )         */ \
    { LEFTSHIFT, HID_KEY_8 },          /* 0x2A *         */ \
    { LEFTSHIFT, HID_KEY_EQUAL },      /* 0x2B +         */ \
    ...
    { 0, HID_KEY_8 },                  /* 0x38 8         */ \
    { 0, HID_KEY_9 },                  /* 0x39 9         */ \
    { LEFTSHIFT, HID_KEY_SEMICOLON },  /* 0x3A :         */ \
    { 0, HID_KEY_SEMICOLON },          /* 0x3B ;         */ \
    { LEFTSHIFT, HID_KEY_COMMA },      /* 0x3C <         */ \
    { 0, HID_KEY_EQUAL },              /* 0x3D =         */ \
    { LEFTSHIFT, HID_KEY_PERIOD },     /* 0x3E >         */ \
    { LEFTSHIFT, HID_KEY_SLASH },      /* 0x3F ?         */ \
\
    { LEFTSHIFT, HID_KEY_2 },     /* 0x40 @         */ \
    { LEFTSHIFT, HID_KEY_A },     /* 0x41 A         */ \
...
\
    ...
    { 0, HID_KEY_Y },                     /* 0x79 y         */ \
    { 0, HID_KEY_Z },                     /* 0x7A z         */ \
    { LEFTSHIFT, HID_KEY_BRACKET_LEFT },  /* 0x7B {         */ \
    { LEFTSHIFT, HID_KEY_BACKSLASH },     /* 0x7C |         */ \
    { LEFTSHIFT, HID_KEY_BRACKET_RIGHT }, /* 0x7D }         */ \
